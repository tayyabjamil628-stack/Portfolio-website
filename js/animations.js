...
(function () {
  ...
  function init3DCards() {
    ...
    const cards = document.querySelectorAll(
      '.portrait-frame, .about-portrait-card, .stat-card, .fact-card, .project-card, .skill-category-card, .experience-card, .certification-card, .info-card, .contact-info-card, .contact-form-card'
    );
