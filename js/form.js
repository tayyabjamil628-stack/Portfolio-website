...
(function () {
  ...
  function initContactForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      // Simulate async network submission (AWS API Gateway / Lambda backend trigger)
      setTimeout(() => {
          ...
          feedbackBox.innerHTML = `
            <div class="feedback-inner">
              ...
              <div>
                ...
                <p>Your message regarding "<em>${subjectInput.value.trim()}</em>" has been submitted successfully. I will review it and reply to <strong>${emailInput.value.trim()}</strong> as soon as possible.</p>
              </div>
            </div>
          `;
        }

        // Reset form inputs and valid states
        form.reset();
